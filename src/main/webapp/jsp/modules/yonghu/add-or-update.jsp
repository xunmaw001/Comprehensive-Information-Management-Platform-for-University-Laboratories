    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑实验室人员</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">实验室人员管理</li>
                        <li class="breadcrumb-item active">编辑实验室人员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">实验室人员信息</h3>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                yonghuName: "实验室人员姓名不能为空",
                sexTypes: "性别不能为空",
                yonghuIdNumber: "身份证号不能为空",
                yonghuPhone: "手机号不能为空",
                yonghuEmail: "邮箱不能为空",
                yonghuPhoto: "照片不能为空",
                shiyanshiTypes: "实验室不能为空",
            }
        }).form();
    }
