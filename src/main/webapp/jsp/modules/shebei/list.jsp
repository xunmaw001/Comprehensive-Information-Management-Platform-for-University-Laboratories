...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">实验室设备管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">实验室设备列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">实验室设备列表</h3>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="yonghuNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="实验室人员姓名" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //     //院级审核结果
            // var yuanjiContentCell = document.createElement('td');
            // //如果图文详情包含图片
            // if (item.yuanjiContent && item.yuanjiContent.indexOf('img') != -1) {
            //     //暂时只考虑图片+文字 和 文字+图片的情况
            //     var beginIndex = item.yuanjiContent.indexOf('<img');
            //     var endIndex = item.yuanjiContent.indexOf('>');
            //         yuanjiContentCell.innerHTML = item.yuanjiContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            // } else {
            //     if (item.yuanjiContent != null && item.yuanjiContent != "" && item.yuanjiContent.length >= 11) {
            //             yuanjiContentCell.innerHTML = item.yuanjiContent.substring(0, 10) + "...";
            //     } else {
            //             yuanjiContentCell.innerHTML = item.yuanjiContent;
            //     }
            // }
            // row.appendChild(yuanjiContentCell);
            //
            //
            //     //校级审核结果
            // var xiaojiContentCell = document.createElement('td');
            // //如果图文详情包含图片
            // if (item.xiaojiContent && item.xiaojiContent.indexOf('img') != -1) {
            //     //暂时只考虑图片+文字 和 文字+图片的情况
            //     var beginIndex = item.xiaojiContent.indexOf('<img');
            //     var endIndex = item.xiaojiContent.indexOf('>');
            //         xiaojiContentCell.innerHTML = item.xiaojiContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            // } else {
            //     if (item.xiaojiContent != null && item.xiaojiContent != "" && item.xiaojiContent.length >= 11) {
            //             xiaojiContentCell.innerHTML = item.xiaojiContent.substring(0, 10) + "...";
            //     } else {
            //             xiaojiContentCell.innerHTML = item.xiaojiContent;
            //     }
            // }
            // row.appendChild(xiaojiContentCell);
            ...
            debugger
            if(window.sessionStorage.getItem('role') == "院级人员" &&(item.shenheTypes == 1 || item.shenheTypes == 3)){
                var editBtn = document.createElement('button');
                ...
                editBtn.setAttribute("onclick", editAttr);
                editBtn.innerHTML = "院级审核";
            }else if(window.sessionStorage.getItem('role') == "校级人员" && (item.shenheTypes == 2 || item.shenheTypes == 5)){
                var editBtn = document.createElement('button');
                var editAttr = 'iddd(' + item.id + ')';
                editBtn.setAttribute("type", "button");
                editBtn.setAttribute("class", "btn btn-warning btn-sm 审核");
        ...
        function iddd(id) {
            if(window.sessionStorage.getItem('role') == "院级人员"){
                $("#shenhe").html(" <option value=\"2\">通过</option> <option value=\"3\">拒绝</option>")
            }else  if(window.sessionStorage.getItem('role') == "校级人员"){
                $("#shenhe").html(" <option value=\"4\">通过</option> <option value=\"5\">拒绝</option>")
            }
            $("#ids").val(id)
        }
        function shenhe() {
            ...
            if (mymessage == true) {
                http("shebei/shenhe?shenhe="+$("#shenhe").val()+"&ids="+$("#ids").val(), "get", {}, (res) => {
                    if(res.code == 0)
                {
                    getDataList();
                    alert('操作成功');
