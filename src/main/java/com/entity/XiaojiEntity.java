 ...
 */
@TableName("xiaoji")
public class XiaojiEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Xiaoji{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", xiaojiName=" + xiaojiName +
            ", sexTypes=" + sexTypes +
            ", xiaojiIdNumber=" + xiaojiIdNumber +
            ", xiaojiPhone=" + xiaojiPhone +
            ", xiaojiEmail=" + xiaojiEmail +
            ", xiaojiPhoto=" + xiaojiPhoto +
